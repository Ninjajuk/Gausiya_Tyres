...
const TwoDivwithCarousel = () => {
    ...
    return (
        <div className="bg-gray-100  min-h-[500px]  py-2 lg:px-[5rem]">
            <div className="container mx-auto px-4 ">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="h-[500px] w-full rounded-2xl shadow-2xl bg-white p-8 flex flex-col justify-center items-center ">
                        ...
                        <button
                            className="mt-auto px-6 py-2  text-white bg-blue-500 rounded-full hover:bg-blue-800 transition-colors cursor-pointer"
                        >
                            Discover More
                        </button>
                    </div>
