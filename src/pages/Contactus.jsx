    ...
    <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center px-6 py-12">
      ...
      >
        ...
        >
          ...
          <p className="text-gray-300 mt-4">123 TyreCare Street, Delhi, India</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-300 mt-4">+91 98765 43210</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-300 mt-4">support@tyrecare.com</p>
        </motion.div>
